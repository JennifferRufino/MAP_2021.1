...
public class ControleProfessorTest {
    ...
    public void setUp() throws Exception {
        professor = new Professor("01", "Fabio Leite");
    ...
    public void testCadastrarProfessor() {
        assertEquals(true, controle.cadastrarProfessor("01", "Fabio Leite", "01", "Métodos Avançados de Programação", "Ciência da Computação", "Segunda 9h - 11h/Sexta 11h - 13:00"));
        assertEquals(true, controle.cadastrarProfessor("01", "Fabio Leite", "02", "Banco de Dados", "Ciência da Computação", "Terça 7h - 9h/Sexta 7h - 09h"));
    }
